...
mixtures are possible \cite{BlokhinDorovsky1995,PKG-Book2018,Pavelka2014b}. In particular, the 
...
formulation for mixtures used in this paper by a term $ \sim w^l\left(\frac{\partial w^k}{\partial 
x_l}-
\frac{\partial w^l}{\partial x_k}\right) $ missing in equation \eqref{eqn.relvelMS}. Nevertheless, 
for the 
case of small amplitude waves, such a term should not result in a different linear system but 
should vanish as vanishes the term $ v^l\left(\frac{\partial w^k}{\partial 
	x_l}-
