...
\begin{abstract} 
\noindent
A multiphase model and its application to the wavefields numerical simulation 
...
difference scheme is used. The results of solving some numerical test problems is presented and discussed.
...
industrial applications. The starting point of research developments in this field was the series 
of pioneering work of Bio \cite{Biot1956,Biot1956a,Biot1962}, 
in which a model of elastic wave propagation in 
saturated porous media was proposed. Some modification and generalization of 
the model 
have been done in the past (see, for example 
\cite{Carcione2010,Masson2006,Winkler1989} and references therein) and at 
present, Biot's approach is 
the commonly accepted and widely used in geophysical community. Nevertheless, many actual 
technological and scientific problems such as geothermal energy extraction, CO2 storage, hydraulic 
fracturing require a development of new advanced models and methods. 
...
Perhaps, most consistently the two-phase approach to poroelasticity has been 
inplemented by Wilmanski in \cite{Wilmanski1998,Wilmanski2006} (see also 
references therin). In particular, in the review paper \cite{Wilmanski2006}, 
the structure of Biot's poroelastic model is analysed and its admissibility 
within the fundamental principles of continuum mechanics is discussed. 

In recent years, considerable attention has been paid to the modeling of large deformations of saturated porous media and their application in various fields, in particular in medicine, see
for example \cite{Khoei2011,Rohan2017,Pesavento2017}.
It is necessary to mention a large deformation model of the saturated porous 
medium proposed by Dorovsky 
\cite{BlokhinDorovsky1995}, in which the key point of the model is its 
thermodynamic consistency and hyperbolicity of the governing equations. 
Nevertheless, there is still no a conventional thermodynamically consistent 
formulation of multiphase mixture flow model in the  deforming porous medium 
taking into account finite deformations. 

In this paper, we apply a powerful method of designing of new models of 
complex continuum media  based on the thermodynamically compatible system 
theory \cite{God1961,Godunov:1995a,Godunov1996} and allowing the development of 
well-posed models satisfying 
...
formulated, which is able to describe many known classical equations of 
continuum mechanics and electrodynamics (fluid mechanics, solid mechanics, 
electrodynamics, magnetohydrodynamics)
including both, advective and dissipative processes. All SHTC systems have nice 
mathematical properties: symmetric hyperbolicity in the sense of Friedrichs 
\cite{Friedrichs1958} and
conservative form of the equations. Solutions of the governing PDE system 
satisfy 
fundamental laws of non-equilibrium irreversible thermodynamics, namely the 
conservation of total energy (first law) and non-decreasing of the physical 
entropy (second law). 

The SHTC system theory is a first principle type theory. It allows to derive 
...
successfully applied to the development of hierarchy of compressible 
multi-phase flow models 
\cite{Romenski2007,RomDrikToro2010,Romenski2016,PeshGrmRom2015}.
 Recently, a unified SHTC model of Newtonian continuum mechanics was developed 
\cite{DPRZ2016,DPRZ2017}, which simultaneously describes the dynamics of 
elastoplastic solids, as well as viscous and non-viscous fluids in the presence 
of electromagnetic field. 
In the present paper, we extend this unified model to the description of 
solid-fluid two-phase flows, and the governing equations of the model 
also belong to the class of SHTC equations. The interfacial friction between 
...
thermodynamics. 
The latter allows to account the dependence of elastic moduli on frequency in 
the time domain and apply a difference numerical methods to study wave 
propagation problems.  

The rest of the paper is organized as follows. Section\,\ref{sec.theory} 
briefly describes governing PDEs for the unified model of continuum mechanics 
and for 
two-phase compressible fluid model. Then, by combining two aforementioned 
models, the governing master SHTC system for two-phase solid-fluid medium is 
formulated.
In Section\,\ref{sec.linear}, on the base of the presented model, the governing 
equations are derived for small amplitude wave propagation in the stationary 
saturated porous medium. 
In Section \ref{Comparison} we
discuss differences and similarities of Biot's and SHTC model.
In Section\,\ref{sec.waves}, we derive dispersion 
relation for the obtained acoustic equations and study the properties of wavefields. 
...
% 
Results by E.R. and G.R. obtained in Sects.2-4 were supported by the Russian Science Foundation grant (project 19-77-20004), whereas results obtained in Sect.5 were supported by RFBR grant 19-01-00347.
I.P. greatly acknowledges the support by Agence nationale de la recherche (FR) 
(Grant No. ANR-11-LABX-0040-CIMI) within the program ANR-11-IDEX-0002-02.
The work by M.D. was partially funded by the European Union's Horizon 2020 Research and Innovation  Programme under the project \textit{ExaHyPE}. 
Furthermore, MD acknowledges funding from the Italian Ministry of Education, University and Research (MIUR) in the frame of the Departments of Excellence Initiative 2018--2022 attributed to DICAM of the University of Trento, as well as financial support from the University of Trento in the frame of the  \textit{Strategic Initiative Modeling and Simulation}.
